			...
			<div className="container mx-auto ">
				<div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
					...
					<div className="text-center xl:text-left order-2 xl:order-none bg-gradient-to-r from-primary/10 via-black/30">
						<span className="h2">
							Modern <span className="text-accent">Full Stack</span> Developer
						</span>
						...
						<p className="max-w-[500px] mb-9 text-white/80 text-[16px] font-semibold text-justify">
							Transforming Ideas Into reality I excel at crafting elegent
							digital experience and I am proficient in various programming
						...
						<div className="flex flex-col xl:flex-row items-center gap-8 ">
							<Link
								href={"/assets/resume/shahzebkhanResume.pdf"}
								target="_blank"
							>
								<Button
									variant="outline"
